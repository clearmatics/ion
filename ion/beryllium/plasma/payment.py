...
@click.command()
@click.option('--secret', metavar='BYTES32', callback=arg_bytes32, help="Secret key")
@click.option('--input', metavar='FILE.json', type=click.File('r'), required=False, help="Load payment from file")
@click.option('--from', 'source', metavar='0x...20', callback=arg_bytes20, required=False, help="Origin address")
@click.option('--to', 'dest', metavar='0x...20', callback=arg_bytes20, required=False, help="Destination address")
@click.option('--currency', metavar='0x...20', callback=arg_bytes20, required=False, help="ERC-223 currency contract address")
@click.option('--reference', metavar='BYTES32', callback=arg_bytes32, required=False, help="Arbitrary 256bit payment reference")
@click.option('--value', metavar='UINT256', callback=arg_uint256)
@click.option('--block-hash', metavar='BYTES32', callback=arg_bytes32, help="Binds payment to a specific block hash")
@click.option("--format", type=click.Choice(['meta', 'json']), default='meta')

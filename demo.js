...
const main = async () => {
  ...
  const tokenA = TokenA.at('0xc89ce4735882c9f0f0fe26686c53074e09b0d550');
  const LockA = web3A.eth.contract(lockAbi);
  const ionLockA = LockA.at('0xd833215cbcc3f914bd1c9ece3ee7bf8b14f841bb');
  const LinkA = web3A.eth.contract(linkAbi);
  const ionLinkA = LinkA.at('0xcfeb869f69431e42cdb54a4f4f105c19c080a601');

  // deploy contracts
  const TokenB = web3B.eth.contract(tokenAbi);
  const tokenB = TokenB.at('0xc89ce4735882c9f0f0fe26686c53074e09b0d550');
  const LockB = web3B.eth.contract(lockAbi);
  const ionLockB = LockB.at('0xd833215cbcc3f914bd1c9ece3ee7bf8b14f841bb');
  const LinkB = web3B.eth.contract(linkAbi);
  const ionLinkB = LinkB.at('0xcfeb869f69431e42cdb54a4f4f105c19c080a601');
